...
?>
  ...
  <section class="l-main">
    ...
    <h2 class="c-title">jQuery</h2>
    <ul class="l-main__article">
      <li>
        <a href="tpl/modal.php">
          <div class="l-main__thum"><img src="https://buff-design.com/demo/img/logo_jquery.png" alt=""></div>
          <h2>モーダルウィンドウ</h2>
        </a>
      </li>
      <li>
